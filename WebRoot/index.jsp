...
<%--					</form>--%>
			...
			<nav id="navigation">
				...
				<ul>
					...
					<li><a href="login.jsp">Cloud Login</a></li>
				</ul>
				<div class="cl">&nbsp;</div>
			</nav>
			<!-- end of navigation -->
...
and vehicle safety.</p>
			...
			<div class="main">
				...
				<section class="cols">
					<div class="col">
						<h3>About Us</h3>
						<p>As an emerging technology caused by rapid advances in
modern wireless telecommunication, IoT has received a lot of
attention and is expected to bring benefits to numerous application
areas including health care, manufacturing, and transportation.</p>
					</div>
					...
					<div class="col">
						...
						<div class="cl">&nbsp;</div>
						<p>The advances in cloud computing and internet of
things (IoT) have provided a promising opportunity to resolve the
challenges caused by the increasing transportation issues.</p>
					</div>

					<div class="col">
						<h3>Our Services</h3>
						<ul>
							<li><a>Cloud Resource Management</a></li>
							<li><a>Intelligent Transportation Systems</a></li>
							<li><a>Internet Of Vehicles</a></li>
							<li><a>Road Side Unit</a></li>
							<li><a>Vehicular Ad Hoc Networks</a></li>
						</ul>
					</div>
					<div class="cl">&nbsp;</div>
				</section>
