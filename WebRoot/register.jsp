		...
		<br/><br/><h3><font size="5px" color="#00BFFF">Software Defined Networking For RSU Clouds in Internet Of Vehicles</font></h3></div>
			...
			<nav id="navigation">
				...
				<ul>
					...
					<li  class="active"><a href="register.jsp">User Register</a></li>
...
and vehicle safety.</p>							</div>
		...
		<h3><font size="5px" color="#00BFFF">USER REGISTRATION</font></h3>
				<s:form name="f">     
                 	<s:textfield name="username" label="UserName"></s:textfield>  
					<s:password name="password" label="Password" ></s:password> 
					<s:password name="confirmpassword" label="ConfirmPassword" ></s:password> 
					<s:textfield name="email" label="Email" ></s:textfield>        
					<s:textfield name="phone" label="Phone" id="phone"></s:textfield> 
					<s:textfield name="address" label="Address" ></s:textfield> 
					<s:textfield name="lcnumber" label="Licence Number" ></s:textfield> 
					<s:submit value="Register" onclick="callsub()"></s:submit>  
