							...
							<div class="banner">
								<table>
									...
									<tr>
										<td>
											<center>
												<a href="vehiclemonitoring.jsp" style="color: #1E90FF;"><s:label>Monitor Vehicles Information</s:label>
												</a>
											</center>
										</td>
									</tr>
									...
									<tr>
										<td>
											<center>
												<a href="http://localhost:9999/PlotView"
													style="color: #1E90FF;"><s:label>Intelligent Parking</s:label>
												</a>
											</center>
										</td>
									</tr>
