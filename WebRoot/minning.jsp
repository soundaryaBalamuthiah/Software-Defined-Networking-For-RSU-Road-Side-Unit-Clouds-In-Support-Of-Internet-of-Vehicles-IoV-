...
and vehicle safety.</p>							</div>
			...
			<div class="main">
				...
				<div align="center">
				<a href="javascript:void(0)" onclick="showhide('drunken')" style="color: red;"><s:label>Drunken</s:label></a><br>
				<a href="javascript:void(0)" onclick="showhide('roads')" style="color: red;"><s:label>Non Safety Roads</s:label></a><br>
				<a href="javascript:void(0)" onclick="showhide('speed')" style="color: red;"><s:label>Over Speed</s:label></a><br/>
				<a href="rfid.jsp" style="color: red;"><s:label>Using RFID</s:label></a>
				</div><br><br>
				   ...
				   ResultSet rs=ps.executeQuery();  
				    if(rs.next())
				    {
				    	...
				    	while(rs1.next())
				    	{
					    	...
					    	<td  style="color: red;"><%=rs1.getString(9)%></td>
				  ...
				  rs=ps.executeQuery();  
				    if(rs.next())
				    {
				    	...
				    	while(rs1.next())
				    	{
					    	...
					    	<td><%=rs1.getString(6)%></td>
					    	<td><%=rs1.getString(7)%></td>
					    	<td style="color: red;"><%=rs1.getString(8)%></td>
				...
				rs=ps.executeQuery(); 
				    if(rs.next())
				    {
				    	...
				    	while(rs1.next())
				    	{
					    	...
					    	<td><%=rs1.getString(5)%></td>
					    	<td><%=rs1.getString(6)%></td>
					    	<td style="color: red;"><%=rs1.getString(7)%></td>
					    	<td><%=rs1.getString(8)%></td>
					    	<td><%=rs1.getString(9)%></td>
					    	<td><%=rs1.getString(10)%></td>
					    	</tr>
